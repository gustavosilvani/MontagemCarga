...
public class IniciarTransitoCarregamentoCommandHandler
    : IRequestHandler<IniciarTransitoCarregamentoCommand, Unit>
{
    private readonly ICarregamentoRepository _repository;
    private readonly ITenantService _tenantService;

    public IniciarTransitoCarregamentoCommandHandler(
    ...
    public async Task<Unit> Handle(IniciarTransitoCarregamentoCommand request, CancellationToken cancellationToken)
    {
